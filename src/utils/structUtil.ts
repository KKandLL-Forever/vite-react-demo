...
import { AIR, FACILITY, POLLUTION_AIR_TYPE, POLLUTION_WATER_TYPE, WATER } from '@/constant'
...
export function transferType(type:string|number){
  switch (type) {
    case AIR :
    case POLLUTION_AIR_TYPE:
      return '废气'
    case WATER:
    case POLLUTION_WATER_TYPE:
      return '废水'
    case FACILITY:
      return '治污设施'
    default:
